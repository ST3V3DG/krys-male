...
const items: FaqItem[] = [
	{
		...
		answer: "Working with me means embarking on a collaborative creative journey where your vision is my priority. I believe that genuine artistic support and personalized attention are essential to bringing your book cover to life in a way that truly resonates with your story and audience.",
	},
	{
		id: "faq-2",
	...
	},
	{
		...
		answer: "This methodical approach ensures that every cover I create is thoughtfully crafted, genuinely original, and perfectly tailored to your book. You are not just getting an illustration; you are getting a partner who is invested in your success and committed to creating artwork that does justice to your story. My accompaniment throughout this process is not optional, it is fundamental to the quality and authenticity of the final product. I look forward to working with you and bringing your vision to life with artistry, integrity, and dedication.",
	},
];

const title = "Frequently asked questions";
const description =
	"Find answers to common questions about our products. Can't find what you're looking for? Contact me for more information.";

export function FaqsSection() {
	return (
		<section className="py-32 bg-primary/40 dark:bg-primary/10">
			<div className=" max-w-6xl mx-auto px-6 space-y-16">
				<div className="mx-auto flex max-w-3xl flex-col text-left md:text-center">
					<h2 className="mb-3 text-3xl font-semibold text-primary md:mb-4 lg:mb-6 lg:text-4xl">{title}</h2>
					<p className="text-muted dark:text-muted-foreground lg:text-lg">{description}</p>
				</div>
					...
					{items.map((item) => (
						<AccordionItem key={item.id} value={item.id}>
							...
							<AccordionContent className="sm:mb-1 lg:mb-2">
								<div className="text-muted-foreground first-letter:ml-4 lg:text-lg">{item.answer}</div>
							</AccordionContent>
						</AccordionItem>
					))}
				</Accordion>
