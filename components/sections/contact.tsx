...
export function ContactSection() {
	return (
		<section className="bg-background @container py-8 lg:py-32">
			<div className="mx-auto max-w-4xl px-6">
				<div>
					<h1 className="text-balance text-4xl font-medium text-primary sm:text-5xl md:text-7xl">
						Get in Touch
					</h1>
				...
				<div className="@xl:grid-cols-5 mt-12 grid gap-8">
					<div className="@xl:col-span-2 space-y-6 *:space-y-2">
						...
						<div>
							...
							<Link href="tel:+1234567890" className="text-muted-foreground hover:text-primary text-sm">
								+1 (234) 567-890
							</Link>
						</div>
