		...
		<section className={cn("py-8 lg:py-32", className)}>
			<div className="max-w-6xl mx-auto px-6">
				<div className="mb-8 text-center">
					...
					<p className="mt-8 text-muted-foreground">See how our products stack up against each other</p>
				</div>
								...
								{products.map((product, index) => (
									...
									>
										<div className="pb-4">
											...
											<h3 className="mt-2 text-lg leading-tight font-semibold">{product.name}</h3>
							...
							{specsGroups.map((specGroup, index) => (
								<>
									...
									{specGroup.specs.map((spec, idx) => (
										<TableRow key={idx}>
											<TableCell className="border-r font-medium">{spec.name}</TableCell>
