    ...
    <section className="bg-secondary/10 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 justify-content-center gap-4">
        <div className="flex flex-col py-24 gap-8">
          ...
          <p className="text-balance">Books have always sparked my imagination and they have become my biggest inspiration in my artworks.
          ...
          <p className="text-balance">Every artwork from me is created solely by me, without any use of Artificial Intelligence. I work with Procreate (iPad), Photoshop and Illustrator to help my visions come to life.
          I've been working in this industry since 2017 and have loved every second of it!</p>
        </div>
        <div>
          <Image alt="illustration" className="object-cover object-center size-full" height={800} src="/images/black-guy.png" width={400} />
        </div>
      </div>
    </section>
  );
