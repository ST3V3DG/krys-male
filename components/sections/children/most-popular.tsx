...
const slideData = [
	{
		...
		description:
			"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vel risus sed metus faucibus auctor. Nulla facilisi. Vestibulum vel tortor at quam elementum consequat.",
		author: "Alex Honnold",
	},
	{
		...
		description:
			"Discover the peace of secluded lakes and the beauty of untouched nature. A story of exploration and finding tranquility.",
		author: "Jane Smith",
	},
	{
			...
			<div className=" max-w-6xl mx-auto px-6">
				<div className="mb-8 flex flex-col items-start justify-between md:flex-row md:items-end">
					...
					<div className="mt-4 flex space-x-2 md:mt-0">
						<Button
							className="rounded-full border cursor-pointer size-8 transition-colors duration-200"
							...
							<div className="min-w-full" key={index}>
								<div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
									...
									<div className="md:pl-8">
										<div className="mb-4">
											<span className="bg-primary/5 text-primary inline-block rounded-full px-3 py-1 text-xs tracking-widest uppercase">
												{" "}
												{slide.category}{" "}
											</span>
										</div>
										<h3 className="mb-6 font-gambarino text-3xl leading-tight font-medium md:text-4xl">
											{slide.title}
										</h3>
