			...
			<div className=" max-w-6xl mx-auto px-6">
				<div className="grid grid-cols-1 gap-5 lg:grid-cols-6 lg:gap-20">
					<div className="top-16 col-span-2 h-fit w-fit gap-3 space-y-7 py-8 lg:sticky">
						...
						<Button variant="ghost" className="flex items-center justify-start gap-2 bg-secondary/20 px-4">
					...
					<ul className="relative col-span-4 w-full lg:pl-22">
						{process.map((step, index) => (
							...
							>
								...
								<div className="tracking-tighter text-primary/20 font-medium text-5xl">
									0{index + 1}
								</div>
								<div>
...
const Illustration = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<line className="stroke-secondary" x1="0.607422" y1="2.57422" x2="21.5762" y2="2.57422" strokeWidth="4" />
			<line className="stroke-secondary" x1="19.5762" y1="19.624" x2="19.5762" y2="4.57422" strokeWidth="4" />
		</svg>
	);
};
