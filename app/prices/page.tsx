...
import { ComparePricesSection, type SpecsGroupsType } from "@/components/sections/compare-prices";
		...
		specs: [
			{
				...
				values: ["Single character", "Complex illustrations", "Complex illustrations"],
			},
...
const servicesPackagesSpecsGroups: SpecsGroupsType = [
	{
		...
		specs: [
			...
			{
				name: "Visual Style",
				values: ["Cohesive visual identity", "Unified aesthetic", "Strong visual continuity"],
			},
			{
				name: "Branding",
				values: ["Series branding guide", "Series logo/branding elements", "Complete brand identity guide"],
			},
			{
				name: "Character Design",
				values: ["Consistent character design", "Character style sheets", "Consistent character design"],
			},
			{
